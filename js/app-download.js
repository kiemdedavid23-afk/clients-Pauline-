...
(function () {
  ...
  // URL stable : pointe toujours vers la dernière Release publiée par le workflow.
  // Le nom du dépôt (VOTRE-COMPTE/VOTRE-DEPOT) est injecté automatiquement au build par GitHub Actions.
  var APK_DOWNLOAD_URL = 'https://github.com/VOTRE-COMPTE/VOTRE-DEPOT/releases/latest/download/chez-tantie-pauline.apk';
